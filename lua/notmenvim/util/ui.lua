...
function M.foldtext()
  ...
  table.insert(ret, { " " .. NotMeNvim.config.icons.misc.dots })
...
function M.statuscolumn()
  ...
  local show_open_folds = vim.g.notmenvim_statuscolumn and vim.g.notmenvim_statuscolumn.folds_open
  local use_githl = vim.g.notmenvim_statuscolumn and vim.g.notmenvim_statuscolumn.folds_githl
  ...
  if show_signs then
    ...
    vim.api.nvim_win_call(win, function()
      ...
      elseif
        show_open_folds
        and not NotMeNvim.ui.skip_foldexpr[buf]
