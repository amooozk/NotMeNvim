return {
  ...
  { import = "notmenvim.plugins.extras.lang.git" },
  ...
  -- Octo Picker
  {
    ...
    opts = function(_, opts)
      ...
      if NotMeNvim.has("telescope.nvim") then
        opts.picker = "telescope"
      elseif NotMeNvim.has("fzf-lua") then
        opts.picker = "fzf-lua"
      else
        NotMeNvim.error("`octo.nvim` requires `telescope.nvim` or `fzf-lua`")
      end
